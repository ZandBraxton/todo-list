...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Raleway:wght@300;600&display=swap);"]);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n    margin: 0;\n    overflow-x: hidden;\n}\n\n\nhtml {\n    box-sizing: border-box;\n    font-family: 'Raleway', sans-serif;\n}\n\n*, *::before, *::after {\n    box-sizing: inherit;\n}\n\n\nform {\n    display: flex;\n    flex-flow: column;\n    width: 50%;\n    margin: 2em auto 0 auto;\n    font-size: 1.4rem;\n}\n\nform input, select, button, label {\n    margin-top: 1em\n}\n\nform button, form input[type=submit] {\n    height: 2rem;\n    font-size: 1.4rem;\n    border-radius: 20px;\n    border: none;\n    background-color: rgb(88, 87, 87);\n    color: white;\n}\n\nform button:hover, form input[type=submit]:hover {\n    background-color: rgba(255, 255, 255, 0.56);\n    outline: 1px solid black; \n    transition: all 0.3s;\n    cursor: pointer;\n}\n\nform button:hover {\n    background-color: rgb(182, 50, 50);\n    color: white;\n}\n\nform input[type=submit]:hover {\n    background-color: rgb(63, 146, 55);\n    color: white\n}\n\n\n\n\n.transition-wrapper {\n\t-webkit-transition: opacity 200ms 0ms ease-in;\n\t-moz-transition: opacity 200ms 0ms ease-in;\n\t-ms-transition: opacity 200ms 0ms ease-in;\n\t-o-transition: opacity 200ms 0ms ease-in;\n\ttransition: opacity 200ms 0ms ease-in;\n    opacity: 0;\n}\n\n.show {\n    opacity: 1;\n}\n\n\n.material-icons {\n    color: rgba(0, 0, 0, 0.56);\n    font-size: 1.6;\n}\n\n\n.material-icons.blue { color: #188be7; }\n.material-icons.red { color: #d82731; }\n.material-icons.purple { color: #a230cf; }\n.material-icons.white { color: #ffffff; }\n\n\n\n.navbar {\n    background-color: rgb(33, 33, 33);\n    height: 100px;\n    width: 100%;\n    display: flex; \n}\n\n.navbar h1 {\n    display: block;\n    color: white;\n    margin: 0 0 0 0.5em ;\n    padding-top: 20px;\n    font-size: 48px;\n}\n\n.navbar button {\n    margin: auto 1em auto auto;\n    width: 20rem;\n    height: 4rem;\n    font-size: 2.3rem;\n    font-family: 'Lato', sans-serif;\n    border-radius: 20px;\n    border: none;\n    background-color: rgb(88, 87, 87);\n    color: white;\n}\n\n.navbar button:hover {\n    background-color: rgb(255,255,255);\n    color:rgba(18, 18, 18, 1);\n    transition: all 0.3s;\n    cursor: pointer;\n}\n\n.time {\n    color: white;\n    font-family: 'Lato', sans-serif;\n    margin: auto 10px auto auto;\n    font-size: 1.5rem;\n}\n\n.sidebar-container {\n    min-height: 100vh;\n    width: 400px;\n    background-color: rgba(18, 18, 18, 1);\n    position: absolute;\n    display: flex;\n    flex-flow: column;\n    top: 100px;\n    bottom: 0;\n    margin-bottom: 0;\n}\n\n.sidebar-items {\n    display: flex;\n    flex-flow: row;\n    width: 20rem;\n    height: auto;\n    padding: 5px;\n    font-size: 1.8rem;\n    margin: 1.1em 0em 0em 1.5em;\n    color: white;\n    border-radius: 20px;\n}\n\n\n.sidebar-items .material-icons {\n    margin-right: 0.4em;\n}\n\n.inbox-counter, .today-counter, .upcoming-counter {\n    margin: 0 1em 0 auto;\n    font-family: 'Lato', sans-serif;\n}\n\n\n.sidebar-items:hover {\n    cursor: pointer;\n    background-color: rgba(77, 78, 78, 0.973);\n    border-radius: 20px;\n    transition: all 0.2s;\n}\n\n.tab-active {\n    font-weight: 800;\n}\n\n.project-header {\n    width: 20rem;\n    height: auto;\n    font-size: 1.8rem;\n    font-weight: 600;\n    margin: 2em 0em 0em 1.5em;\n    color: white;\n}\n\n.projects {\n    font-size: 32px;\n    font-weight: 100;\n    margin: 20px 0px 0px 40px;\n}\n\n.add-project {\n    width: 50%;\n    margin: 4.5em auto 0px auto;\n    width: 10rem;\n    height: 4rem;\n    font-size: 1.6rem;\n    font-family: 'Lato', sans-serif;\n    border-radius: 20px;\n    border: none;\n    background-color: rgb(88, 87, 87);\n    color: white;\n}\n\n.add-project:hover {\n    background-color: rgb(255,255,255);\n    color:rgba(18, 18, 18, 1);\n    transition: all 0.3s;\n    cursor: pointer;\n}\n\n.main {\n    width: 60%;\n    height: 100vh;\n    margin-left: 500px;\n}\n\n.empty {\n    font-size: 1.4rem;\n    text-align: center;\n    margin-top: 3em;\n}\n\n\n.list {\n    position: relative;\n}\n\n.col-name {\n    display: grid;\n    grid-template-columns: repeat(4, 1fr);\n    margin-bottom: 1em;\n    font-weight: 600;\n    font-size: 1.4rem;\n}\n\n.col-name-item {\n    grid-column: 2;\n}\n\n.task-list {\n    display: grid;\n    grid-template-columns: repeat(4, 1fr);\n    grid-template-rows: repeat(auto-fit, 1fr);\n    margin-bottom: 1em;\n    outline: 1px solid rgba(160, 159, 159, 0.56);\n    transition: all 0.1s;\n}\n\n.task-list:hover {\n    background-color: rgba(189, 187, 187, 0.56);\n    outline: 1px solid black;\n}\n\n.checker {\n    margin: auto;\n    width: 48px;\n    height: auto;\n    border-radius: 50%;\n    background-color: rgba(255, 255, 255, 0.815);\n}\n\n.checker span {\n    margin-top: 2px;\n    font-size: 36px;\n}\n\n.checker:hover {\n    outline: 1px solid rgba(0, 0, 0, 0.56);\n    transition: none;\n}\n\n.task-item {\n    margin: auto;\n    width: 100%;\n    font-family: 'Lato', sans-serif;\n    font-weight: 400;\n    font-size: 1.4rem;\n}\n\n.task-list .menu {\n   align-self: center;\n}\n\n.complete {\n    color: rgb(19, 182, 19);\n}\n\n\n.title {\n    width: 100%;\n    font-size: 4rem;\n    margin: 0 auto auto 1em;\n    padding: 0.5em 0 0.3em 0;\n    font-weight: 600;\n}\n\n.desc {\n    width: 100%;\n    margin: 0 0 2em 4.5em;\n    color: rgba(0, 0, 0, 0.911);\n}\n\n.sidebar-project {\n    display: flex;\n    flex-flow: row nowrap;\n    width: 15rem;\n    height: 3rem;\n    margin: 0.8em 0em 0em 1.5em;\n    align-items: center;\n    position: relative;\n}\n\n.sidebar-item-name {\n    font-size: 1.4rem;\n    width: 12rem;\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis;\n}\n\n.project-counter {\n    color: white;\n    background-color: rgba(201, 49, 11, 0.753);\n    width: 36px;\n    height: 32px;\n    text-align: center;\n    font-size: 24px;\n    margin-right: 2em;\n    border-radius: 25%;\n    line-height: 30px;\n    font-weight: 400;\n    font-family: 'Lato', sans-serif;\n}\n\n.sidebar-project .menu {\n    color: white;\n}\n\n.menu {\n    cursor: pointer;\n    margin: 0;\n    right: 0px;\n    position: absolute;\n}\n\n.menu-dropdown {\n   display: none;\n}\n\n\n.menu-dropdown.active {\n    display: flex;\n    flex-flow: column;\n    margin: -1.0em 0em 0em 1.4em;\n    position: absolute;\n  }\n\n  .menu-dropdown button {\n    border-radius: 10px;\n    border: none;\n    background-color: rgb(88, 87, 87);\n    color: white;\n  }\n\n  .menu-dropdown button:hover {\n    background-color: rgb(255,255,255);\n    color:rgba(18, 18, 18, 1);\n    transition: all 0.3s;\n    cursor: pointer;\n    outline: 1px solid black;\n  }\n\n  .sidebar-items button {\n      margin-left:  1em;\n  }\n\n  .sidebar-items button:hover {\n    background-color: rgb(255,255,255);\n    color:rgba(18, 18, 18, 1);\n    transition: all 0.3s;\n    cursor: pointer; \n    outline: none;\n  }\n\n  .notes {\n    grid-column: 1 / span 3;\n    font-size: 1.4rem;\n    margin: 2em auto 0 6em;\n    padding-bottom: 0.6em;\n  }\n\n  .note-active {\n    margin-bottom: 2em;\n  }\n\n  .edit-note {\n    margin: 0px 1em 1em 0px;\n    position: absolute;\n    right: 0;\n    border-radius: 25px;\n    background-color: rgb(88, 87, 87);\n    color: white;\n    width: 10em;\n    transition: all 0.1s;\n    border: none;\n  }\n  .edit-note:hover {\n    background-color: rgba(255, 255, 255, 0.56);\n    color: black;\n    outline: 1px solid black; \n    cursor: pointer;\n  }\n\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,kBAAkB;AACtB;;;AAGA;IACI,sBAAsB;IACtB,kCAAkC;AACtC;;AAEA;IACI,mBAAmB;AACvB;;;AAGA;IACI,aAAa;IACb,iBAAiB;IACjB,UAAU;IACV,uBAAuB;IACvB,iBAAiB;AACrB;;AAEA;IACI;AACJ;;AAEA;IACI,YAAY;IACZ,iBAAiB;IACjB,mBAAmB;IACnB,YAAY;IACZ,iCAAiC;IACjC,YAAY;AAChB;;AAEA;IACI,2CAA2C;IAC3C,wBAAwB;IACxB,oBAAoB;IACpB,eAAe;AACnB;;AAEA;IACI,kCAAkC;IAClC,YAAY;AAChB;;AAEA;IACI,kCAAkC;IAClC;AACJ;;;;;AASA;CACC,6CAA6C;CAC7C,0CAA0C;CAC1C,yCAAyC;CACzC,wCAAwC;CACxC,qCAAqC;IAClC,UAAU;AACd;;AAEA;IACI,UAAU;AACd;;;AAGA;IACI,0BAA0B;IAC1B,cAAc;AAClB;;;AAGA,uBAAuB,cAAc,EAAE;AACvC,sBAAsB,cAAc,EAAE;AACtC,yBAAyB,cAAc,EAAE;AACzC,wBAAwB,cAAc,EAAE;;;;AAIxC;IACI,iCAAiC;IACjC,aAAa;IACb,WAAW;IACX,aAAa;AACjB;;AAEA;IACI,cAAc;IACd,YAAY;IACZ,oBAAoB;IACpB,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,0BAA0B;IAC1B,YAAY;IACZ,YAAY;IACZ,iBAAiB;IACjB,+BAA+B;IAC/B,mBAAmB;IACnB,YAAY;IACZ,iCAAiC;IACjC,YAAY;AAChB;;AAEA;IACI,kCAAkC;IAClC,yBAAyB;IACzB,oBAAoB;IACpB,eAAe;AACnB;;AAEA;IACI,YAAY;IACZ,+BAA+B;IAC/B,2BAA2B;IAC3B,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;IACjB,YAAY;IACZ,qCAAqC;IACrC,kBAAkB;IAClB,aAAa;IACb,iBAAiB;IACjB,UAAU;IACV,SAAS;IACT,gBAAgB;AACpB;;AAEA;IACI,aAAa;IACb,cAAc;IACd,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,iBAAiB;IACjB,2BAA2B;IAC3B,YAAY;IACZ,mBAAmB;AACvB;;;AAGA;IACI,mBAAmB;AACvB;;AAEA;IACI,oBAAoB;IACpB,+BAA+B;AACnC;;;AAGA;IACI,eAAe;IACf,yCAAyC;IACzC,mBAAmB;IACnB,oBAAoB;AACxB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,iBAAiB;IACjB,gBAAgB;IAChB,yBAAyB;IACzB,YAAY;AAChB;;AAEA;IACI,eAAe;IACf,gBAAgB;IAChB,yBAAyB;AAC7B;;AAEA;IACI,UAAU;IACV,2BAA2B;IAC3B,YAAY;IACZ,YAAY;IACZ,iBAAiB;IACjB,+BAA+B;IAC/B,mBAAmB;IACnB,YAAY;IACZ,iCAAiC;IACjC,YAAY;AAChB;;AAEA;IACI,kCAAkC;IAClC,yBAAyB;IACzB,oBAAoB;IACpB,eAAe;AACnB;;AAEA;IACI,UAAU;IACV,aAAa;IACb,kBAAkB;AACtB;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;IAClB,eAAe;AACnB;;;AAGA;IACI,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,qCAAqC;IACrC,kBAAkB;IAClB,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,aAAa;IACb,qCAAqC;IACrC,yCAAyC;IACzC,kBAAkB;IAClB,4CAA4C;IAC5C,oBAAoB;AACxB;;AAEA;IACI,2CAA2C;IAC3C,wBAAwB;AAC5B;;AAEA;IACI,YAAY;IACZ,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,4CAA4C;AAChD;;AAEA;IACI,eAAe;IACf,eAAe;AACnB;;AAEA;IACI,sCAAsC;IACtC,gBAAgB;AACpB;;AAEA;IACI,YAAY;IACZ,WAAW;IACX,+BAA+B;IAC/B,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;GACG,kBAAkB;AACrB;;AAEA;IACI,uBAAuB;AAC3B;;;AAGA;IACI,WAAW;IACX,eAAe;IACf,uBAAuB;IACvB,wBAAwB;IACxB,gBAAgB;AACpB;;AAEA;IACI,WAAW;IACX,qBAAqB;IACrB,2BAA2B;AAC/B;;AAEA;IACI,aAAa;IACb,qBAAqB;IACrB,YAAY;IACZ,YAAY;IACZ,2BAA2B;IAC3B,mBAAmB;IACnB,kBAAkB;AACtB;;AAEA;IACI,iBAAiB;IACjB,YAAY;IACZ,mBAAmB;IACnB,gBAAgB;IAChB,uBAAuB;AAC3B;;AAEA;IACI,YAAY;IACZ,0CAA0C;IAC1C,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,eAAe;IACf,iBAAiB;IACjB,kBAAkB;IAClB,iBAAiB;IACjB,gBAAgB;IAChB,+BAA+B;AACnC;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,eAAe;IACf,SAAS;IACT,UAAU;IACV,kBAAkB;AACtB;;AAEA;GACG,aAAa;AAChB;;;AAGA;IACI,aAAa;IACb,iBAAiB;IACjB,4BAA4B;IAC5B,kBAAkB;EACpB;;EAEA;IACE,mBAAmB;IACnB,YAAY;IACZ,iCAAiC;IACjC,YAAY;EACd;;EAEA;IACE,kCAAkC;IAClC,yBAAyB;IACzB,oBAAoB;IACpB,eAAe;IACf,wBAAwB;EAC1B;;EAEA;MACI,iBAAiB;EACrB;;EAEA;IACE,kCAAkC;IAClC,yBAAyB;IACzB,oBAAoB;IACpB,eAAe;IACf,aAAa;EACf;;EAEA;IACE,uBAAuB;IACvB,iBAAiB;IACjB,sBAAsB;IACtB,qBAAqB;EACvB;;EAEA;IACE,kBAAkB;EACpB;;EAEA;IACE,uBAAuB;IACvB,kBAAkB;IAClB,QAAQ;IACR,mBAAmB;IACnB,iCAAiC;IACjC,YAAY;IACZ,WAAW;IACX,oBAAoB;IACpB,YAAY;EACd;EACA;IACE,2CAA2C;IAC3C,YAAY;IACZ,wBAAwB;IACxB,eAAe;EACjB","sourcesContent":["body {\n    margin: 0;\n    overflow-x: hidden;\n}\n\n\nhtml {\n    box-sizing: border-box;\n    font-family: 'Raleway', sans-serif;\n}\n\n*, *::before, *::after {\n    box-sizing: inherit;\n}\n\n\nform {\n    display: flex;\n    flex-flow: column;\n    width: 50%;\n    margin: 2em auto 0 auto;\n    font-size: 1.4rem;\n}\n\nform input, select, button, label {\n    margin-top: 1em\n}\n\nform button, form input[type=submit] {\n    height: 2rem;\n    font-size: 1.4rem;\n    border-radius: 20px;\n    border: none;\n    background-color: rgb(88, 87, 87);\n    color: white;\n}\n\nform button:hover, form input[type=submit]:hover {\n    background-color: rgba(255, 255, 255, 0.56);\n    outline: 1px solid black; \n    transition: all 0.3s;\n    cursor: pointer;\n}\n\nform button:hover {\n    background-color: rgb(182, 50, 50);\n    color: white;\n}\n\nform input[type=submit]:hover {\n    background-color: rgb(63, 146, 55);\n    color: white\n}\n\n\n@import url('https://fonts.googleapis.com/css2?family=Raleway:wght@300;600&display=swap');\n@import url('https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700&display=swap');\n\n\n\n\n.transition-wrapper {\n\t-webkit-transition: opacity 200ms 0ms ease-in;\n\t-moz-transition: opacity 200ms 0ms ease-in;\n\t-ms-transition: opacity 200ms 0ms ease-in;\n\t-o-transition: opacity 200ms 0ms ease-in;\n\ttransition: opacity 200ms 0ms ease-in;\n    opacity: 0;\n}\n\n.show {\n    opacity: 1;\n}\n\n\n.material-icons {\n    color: rgba(0, 0, 0, 0.56);\n    font-size: 1.6;\n}\n\n\n.material-icons.blue { color: #188be7; }\n.material-icons.red { color: #d82731; }\n.material-icons.purple { color: #a230cf; }\n.material-icons.white { color: #ffffff; }\n\n\n\n.navbar {\n    background-color: rgb(33, 33, 33);\n    height: 100px;\n    width: 100%;\n    display: flex; \n}\n\n.navbar h1 {\n    display: block;\n    color: white;\n    margin: 0 0 0 0.5em ;\n    padding-top: 20px;\n    font-size: 48px;\n}\n\n.navbar button {\n    margin: auto 1em auto auto;\n    width: 20rem;\n    height: 4rem;\n    font-size: 2.3rem;\n    font-family: 'Lato', sans-serif;\n    border-radius: 20px;\n    border: none;\n    background-color: rgb(88, 87, 87);\n    color: white;\n}\n\n.navbar button:hover {\n    background-color: rgb(255,255,255);\n    color:rgba(18, 18, 18, 1);\n    transition: all 0.3s;\n    cursor: pointer;\n}\n\n.time {\n    color: white;\n    font-family: 'Lato', sans-serif;\n    margin: auto 10px auto auto;\n    font-size: 1.5rem;\n}\n\n.sidebar-container {\n    min-height: 100vh;\n    width: 400px;\n    background-color: rgba(18, 18, 18, 1);\n    position: absolute;\n    display: flex;\n    flex-flow: column;\n    top: 100px;\n    bottom: 0;\n    margin-bottom: 0;\n}\n\n.sidebar-items {\n    display: flex;\n    flex-flow: row;\n    width: 20rem;\n    height: auto;\n    padding: 5px;\n    font-size: 1.8rem;\n    margin: 1.1em 0em 0em 1.5em;\n    color: white;\n    border-radius: 20px;\n}\n\n\n.sidebar-items .material-icons {\n    margin-right: 0.4em;\n}\n\n.inbox-counter, .today-counter, .upcoming-counter {\n    margin: 0 1em 0 auto;\n    font-family: 'Lato', sans-serif;\n}\n\n\n.sidebar-items:hover {\n    cursor: pointer;\n    background-color: rgba(77, 78, 78, 0.973);\n    border-radius: 20px;\n    transition: all 0.2s;\n}\n\n.tab-active {\n    font-weight: 800;\n}\n\n.project-header {\n    width: 20rem;\n    height: auto;\n    font-size: 1.8rem;\n    font-weight: 600;\n    margin: 2em 0em 0em 1.5em;\n    color: white;\n}\n\n.projects {\n    font-size: 32px;\n    font-weight: 100;\n    margin: 20px 0px 0px 40px;\n}\n\n.add-project {\n    width: 50%;\n    margin: 4.5em auto 0px auto;\n    width: 10rem;\n    height: 4rem;\n    font-size: 1.6rem;\n    font-family: 'Lato', sans-serif;\n    border-radius: 20px;\n    border: none;\n    background-color: rgb(88, 87, 87);\n    color: white;\n}\n\n.add-project:hover {\n    background-color: rgb(255,255,255);\n    color:rgba(18, 18, 18, 1);\n    transition: all 0.3s;\n    cursor: pointer;\n}\n\n.main {\n    width: 60%;\n    height: 100vh;\n    margin-left: 500px;\n}\n\n.empty {\n    font-size: 1.4rem;\n    text-align: center;\n    margin-top: 3em;\n}\n\n\n.list {\n    position: relative;\n}\n\n.col-name {\n    display: grid;\n    grid-template-columns: repeat(4, 1fr);\n    margin-bottom: 1em;\n    font-weight: 600;\n    font-size: 1.4rem;\n}\n\n.col-name-item {\n    grid-column: 2;\n}\n\n.task-list {\n    display: grid;\n    grid-template-columns: repeat(4, 1fr);\n    grid-template-rows: repeat(auto-fit, 1fr);\n    margin-bottom: 1em;\n    outline: 1px solid rgba(160, 159, 159, 0.56);\n    transition: all 0.1s;\n}\n\n.task-list:hover {\n    background-color: rgba(189, 187, 187, 0.56);\n    outline: 1px solid black;\n}\n\n.checker {\n    margin: auto;\n    width: 48px;\n    height: auto;\n    border-radius: 50%;\n    background-color: rgba(255, 255, 255, 0.815);\n}\n\n.checker span {\n    margin-top: 2px;\n    font-size: 36px;\n}\n\n.checker:hover {\n    outline: 1px solid rgba(0, 0, 0, 0.56);\n    transition: none;\n}\n\n.task-item {\n    margin: auto;\n    width: 100%;\n    font-family: 'Lato', sans-serif;\n    font-weight: 400;\n    font-size: 1.4rem;\n}\n\n.task-list .menu {\n   align-self: center;\n}\n\n.complete {\n    color: rgb(19, 182, 19);\n}\n\n\n.title {\n    width: 100%;\n    font-size: 4rem;\n    margin: 0 auto auto 1em;\n    padding: 0.5em 0 0.3em 0;\n    font-weight: 600;\n}\n\n.desc {\n    width: 100%;\n    margin: 0 0 2em 4.5em;\n    color: rgba(0, 0, 0, 0.911);\n}\n\n.sidebar-project {\n    display: flex;\n    flex-flow: row nowrap;\n    width: 15rem;\n    height: 3rem;\n    margin: 0.8em 0em 0em 1.5em;\n    align-items: center;\n    position: relative;\n}\n\n.sidebar-item-name {\n    font-size: 1.4rem;\n    width: 12rem;\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis;\n}\n\n.project-counter {\n    color: white;\n    background-color: rgba(201, 49, 11, 0.753);\n    width: 36px;\n    height: 32px;\n    text-align: center;\n    font-size: 24px;\n    margin-right: 2em;\n    border-radius: 25%;\n    line-height: 30px;\n    font-weight: 400;\n    font-family: 'Lato', sans-serif;\n}\n\n.sidebar-project .menu {\n    color: white;\n}\n\n.menu {\n    cursor: pointer;\n    margin: 0;\n    right: 0px;\n    position: absolute;\n}\n\n.menu-dropdown {\n   display: none;\n}\n\n\n.menu-dropdown.active {\n    display: flex;\n    flex-flow: column;\n    margin: -1.0em 0em 0em 1.4em;\n    position: absolute;\n  }\n\n  .menu-dropdown button {\n    border-radius: 10px;\n    border: none;\n    background-color: rgb(88, 87, 87);\n    color: white;\n  }\n\n  .menu-dropdown button:hover {\n    background-color: rgb(255,255,255);\n    color:rgba(18, 18, 18, 1);\n    transition: all 0.3s;\n    cursor: pointer;\n    outline: 1px solid black;\n  }\n\n  .sidebar-items button {\n      margin-left:  1em;\n  }\n\n  .sidebar-items button:hover {\n    background-color: rgb(255,255,255);\n    color:rgba(18, 18, 18, 1);\n    transition: all 0.3s;\n    cursor: pointer; \n    outline: none;\n  }\n\n  .notes {\n    grid-column: 1 / span 3;\n    font-size: 1.4rem;\n    margin: 2em auto 0 6em;\n    padding-bottom: 0.6em;\n  }\n\n  .note-active {\n    margin-bottom: 2em;\n  }\n\n  .edit-note {\n    margin: 0px 1em 1em 0px;\n    position: absolute;\n    right: 0;\n    border-radius: 25px;\n    background-color: rgb(88, 87, 87);\n    color: white;\n    width: 10em;\n    transition: all 0.1s;\n    border: none;\n  }\n  .edit-note:hover {\n    background-color: rgba(255, 255, 255, 0.56);\n    color: black;\n    outline: 1px solid black; \n    cursor: pointer;\n  }\n\n"],"sourceRoot":""}]);
// Exports
...
function getList(tasks) {
    ...
    for (let i = 0; i < storedTasks.length; i++) {
        let task = new _taskfactory__WEBPACK_IMPORTED_MODULE_0__.default(storedTasks[i])
        tasks.push(task)
    }
}
...
function getProjects(projects, tasks) {
    ...
    for (let i = 0; i < storedProjects.length; i++) {
        let project = new _projectfactory__WEBPACK_IMPORTED_MODULE_1__.default(storedProjects[i])
...
class taskFactory {
    constructor({name, dueDate, priority, bool, project, notes}) {
        ...
        const date = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__.default)(new Date(utcDateOnly), 'MM/dd/yyyy')
        this.dueDate = date
...
function getDate() {
    ...
    const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(new Date(timeElapsed), 'P')
    return today
}
...
function compareDate(dueDate) {
    let time = getDate()
    let result = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(new Date(dueDate), new Date(time))
    if (result === 1 || result === 0) {
        let week = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.default)(new Date(time), 7)
        result = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(new Date(dueDate), week)
        if (result === -1 || result === 0) {
            return true
        }
    } else {
...
let tasks = []
let projects = []
;(0,_modules_storage__WEBPACK_IMPORTED_MODULE_1__.getList)(tasks)
;(0,_modules_storage__WEBPACK_IMPORTED_MODULE_1__.getProjects)(projects, tasks)
...
const appLogic = (() => { 
    ...
    function appendTask(form) {
        let newTask = new _modules_taskfactory__WEBPACK_IMPORTED_MODULE_2__.default({
            ...
            tasks.push(newTask)
            sortbyPrior()
            ;(0,_modules_storage__WEBPACK_IMPORTED_MODULE_1__.saveList)(tasks)
    }

    function appendProject(form) {
        let newProject = new _modules_projectfactory__WEBPACK_IMPORTED_MODULE_3__.default({
            name: form.elements[0].value,
        ...
        ;(0,_modules_storage__WEBPACK_IMPORTED_MODULE_1__.saveProject)(projects)
